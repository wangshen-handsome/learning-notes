import{_ as s,o as a,c as n,N as l}from"./chunks/framework.e454f055.js";const A=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"fifthStage/fifthStagefour.md","lastUpdated":1684891561000}'),p={name:"fifthStage/fifthStagefour.md"},o=l(`<div class="language-js"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#676E95;font-style:italic;">/*</span></span>
...
<span class="line"></span></code></pre></div><h2 id="一、知识点回顾" tabindex="-1">一、知识点回顾 <a class="header-anchor" href="#一、知识点回顾" aria-label="Permalink to &quot;一、知识点回顾&quot;">​</a></h2><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">暂无</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><h2 id="二、作业讲解" tabindex="-1">二、作业讲解 <a class="header-anchor" href="#二、作业讲解" aria-label="Permalink to &quot;二、作业讲解&quot;">​</a></h2><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">暂无</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><h2 id="三、图片组件和地图组件" tabindex="-1">三、图片组件和地图组件 <a class="header-anchor" href="#三、图片组件和地图组件" aria-label="Permalink to &quot;三、图片组件和地图组件&quot;">​</a></h2><div class="language-html"><button title="Copy Code" class="copy"></button><span class="lang">html</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#89DDFF;">&lt;</span><span style="color:#F07178;">image</span><span style="color:#89DDFF;"> </span><span style="color:#C792EA;">src</span><span style="color:#89DDFF;">=</span><span style="color:#89DDFF;">&quot;</span><span style="color:#C3E88D;">/img/one.png</span><span style="color:#89DDFF;">&quot;</span><span style="color:#89DDFF;"> </span><span style="color:#C792EA;">lazy-load</span><span style="color:#89DDFF;"> 	</span><span style="color:#C792EA;">show-menu-by-longpress</span><span style="color:#89DDFF;"> </span><span style="color:#C792EA;">bindload</span><span style="color:#89DDFF;">=</span><span style="color:#89DDFF;">&quot;</span><span style="color:#C3E88D;">_load</span><span style="color:#89DDFF;">&quot;</span><span style="color:#89DDFF;">&gt;&lt;/</span><span style="color:#F07178;">image</span><span style="color:#89DDFF;">&gt;</span></span>
<span class="line"><span style="color:#A6ACCD;">lazy-load  懒加载</span></span>
<span class="line"><span style="color:#A6ACCD;">show-menu-by-longpress  长按出现保存、小程序码。。。</span></span>
<span class="line"></span>
<span class="line"></span></code></pre></div><div class="language-js"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#89DDFF;">&lt;</span><span style="color:#F07178;">map</span><span style="color:#89DDFF;"> </span><span style="color:#C792EA;">longitude</span><span style="color:#89DDFF;">=</span><span style="color:#89DDFF;">&quot;</span><span style="color:#C3E88D;">{{longitude}}</span><span style="color:#89DDFF;">&quot;</span><span style="color:#89DDFF;"> </span><span style="color:#C792EA;">latitude</span><span style="color:#89DDFF;">=</span><span style="color:#89DDFF;">&quot;</span><span style="color:#C3E88D;">{{latitude}}</span><span style="color:#89DDFF;">&quot;</span><span style="color:#89DDFF;"> </span><span style="color:#C792EA;">markers</span><span style="color:#89DDFF;">=</span><span style="color:#89DDFF;">&quot;</span><span style="color:#C3E88D;">{{mark}}</span><span style="color:#89DDFF;">&quot;</span><span style="color:#89DDFF;">&gt;&lt;/</span><span style="color:#F07178;">map</span><span style="color:#89DDFF;">&gt;</span></span>
<span class="line"></span>
<span class="line"></span>
...
<span class="line"><span style="color:#A6ACCD;">    </span><span style="color:#89DDFF;">}</span></span>
<span class="line"><span style="color:#A6ACCD;">  </span><span style="color:#89DDFF;">}</span></span>
<span class="line"></span></code></pre></div><h2 id="四、导航" tabindex="-1">四、导航 <a class="header-anchor" href="#四、导航" aria-label="Permalink to &quot;四、导航&quot;">​</a></h2><p>vue跳转</p><div class="language-js"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#89DDFF;">&lt;</span><span style="color:#FFCB6B;">router-link</span><span style="color:#89DDFF;"> </span><span style="color:#C792EA;">to</span><span style="color:#89DDFF;">=</span><span style="color:#89DDFF;">&quot;</span><span style="color:#C3E88D;">/login</span><span style="color:#89DDFF;">&quot;</span><span style="color:#89DDFF;">&gt;&lt;/</span><span style="color:#FFCB6B;">router-link</span><span style="color:#89DDFF;">&gt;</span></span>
<span class="line"></span>
...
<span class="line"></span></code></pre></div><h3 id="_4-1导航组件-声明式导航" tabindex="-1">4.1导航组件（声明式导航） <a class="header-anchor" href="#_4-1导航组件-声明式导航" aria-label="Permalink to &quot;4.1导航组件（声明式导航）&quot;">​</a></h3><div class="language-html"><button title="Copy Code" class="copy"></button><span class="lang">html</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#676E95;font-style:italic;">&lt;!-- </span></span>
<span class="line"></span>
...
<span class="line"><span style="color:#F07178;">    </span><span style="color:#89DDFF;">}</span><span style="color:#F07178;">)</span></span>
<span class="line"><span style="color:#F07178;">  </span><span style="color:#89DDFF;">}</span></span>
<span class="line"></span></code></pre></div><h3 id="_4-3导航传参" tabindex="-1">4.3导航传参 <a class="header-anchor" href="#_4-3导航传参" aria-label="Permalink to &quot;4.3导航传参&quot;">​</a></h3><div class="language-js"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">(</span><span style="color:#F78C6C;">1</span><span style="color:#A6ACCD;">)组件形式传参  直接拼接</span></span>
...
<span class="line"><span style="color:#A6ACCD;">    </span><span style="color:#89DDFF;">}</span><span style="color:#A6ACCD;">)</span></span>
<span class="line"></span>
<span class="line"></span></code></pre></div><h3 id="_4-4接收导航传参" tabindex="-1">4.4接收导航传参 <a class="header-anchor" href="#_4-4接收导航传参" aria-label="Permalink to &quot;4.4接收导航传参&quot;">​</a></h3><div class="language-js"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">在到达的页面的onLoad声明周期函数里接收</span></span>
...
<span class="line"><span style="color:#F07178;">  </span><span style="color:#89DDFF;">}</span></span>
<span class="line"></span>
<span class="line"></span></code></pre></div><p><strong>说明</strong>：可以在微信开发者工具选择普通编译--继续选择添加编译模式--选择启动页面--添加启动参数即可，然后即可在当前目标页面的onLoad中获取参数</p><h2 id="五、自定义组件" tabindex="-1">五、自定义组件 <a class="header-anchor" href="#五、自定义组件" aria-label="Permalink to &quot;五、自定义组件&quot;">​</a></h2><p>自己封装组件</p><h3 id="_5-1概述" tabindex="-1">5.1概述 <a class="header-anchor" href="#_5-1概述" aria-label="Permalink to &quot;5.1概述&quot;">​</a></h3><p>小程序支持简洁的组件化编程，开发者可以将页面内的功能模块抽象成自定义组件，以便在不同的页面中重复使用；自定义组件在使用时与基础组件非常相似</p><h3 id="_5-2创建自定义组件" tabindex="-1">5.2创建自定义组件 <a class="header-anchor" href="#_5-2创建自定义组件" aria-label="Permalink to &quot;5.2创建自定义组件&quot;">​</a></h3><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">暂无</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><h3 id="_5-3组件引用与使用" tabindex="-1">5.3组件引用与使用 <a class="header-anchor" href="#_5-3组件引用与使用" aria-label="Permalink to &quot;5.3组件引用与使用&quot;">​</a></h3><div class="language-json"><button title="Copy Code" class="copy"></button><span class="lang">json</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">局部引用： 在某个页面的json文件里引用</span></span>
<span class="line"></span>
...
<span class="line"><span style="color:#A6ACCD;">  </span><span style="color:#89DDFF;">}</span></span>
<span class="line"></span>
<span class="line"></span></code></pre></div><div class="language-html"><button title="Copy Code" class="copy"></button><span class="lang">html</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">使用：</span></span>
<span class="line"><span style="color:#89DDFF;">&lt;</span><span style="color:#F07178;">my-btn</span><span style="color:#89DDFF;">&gt;&lt;/</span><span style="color:#F07178;">my-btn</span><span style="color:#89DDFF;">&gt;</span></span>
<span class="line"></span>
<span class="line"></span></code></pre></div><h3 id="_5-4丰富组件" tabindex="-1">5.4丰富组件 <a class="header-anchor" href="#_5-4丰富组件" aria-label="Permalink to &quot;5.4丰富组件&quot;">​</a></h3><p>定义了一个按钮</p><div class="language-js"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">组件的wxml里</span></span>
...
<span class="line"><span style="color:#F07178;">  </span><span style="color:#89DDFF;">}</span></span>
<span class="line"></span>
<span class="line"></span></code></pre></div><h3 id="_5-6properties组件对外开放属性" tabindex="-1">5.6properties组件对外开放属性 <a class="header-anchor" href="#_5-6properties组件对外开放属性" aria-label="Permalink to &quot;5.6properties组件对外开放属性&quot;">​</a></h3><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">// 调用组件时  传来的属性 必须在properties定义 </span></span>
<span class="line"><span style="color:#A6ACCD;">在丰富组件里</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><h3 id="_5-7slot插槽使用" tabindex="-1">5.7slot插槽使用 <a class="header-anchor" href="#_5-7slot插槽使用" aria-label="Permalink to &quot;5.7slot插槽使用&quot;">​</a></h3><h4 id="_5-7-1默认插槽-只有一个插槽" tabindex="-1">5.7.1默认插槽 只有一个插槽 <a class="header-anchor" href="#_5-7-1默认插槽-只有一个插槽" aria-label="Permalink to &quot;5.7.1默认插槽  只有一个插槽&quot;">​</a></h4><div class="language-html"><button title="Copy Code" class="copy"></button><span class="lang">html</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">组件的wxml里</span></span>
<span class="line"><span style="color:#89DDFF;">&lt;</span><span style="color:#F07178;">view</span><span style="color:#89DDFF;"> </span><span style="color:#C792EA;">class</span><span style="color:#89DDFF;">=</span><span style="color:#89DDFF;">&quot;</span><span style="color:#C3E88D;">{{size}}</span><span style="color:#89DDFF;">&quot;</span><span style="color:#89DDFF;"> </span><span style="color:#C792EA;">style</span><span style="color:#89DDFF;">=</span><span style="color:#89DDFF;">&quot;</span><span style="color:#C3E88D;">background:{{color}}</span><span style="color:#89DDFF;">&quot;</span><span style="color:#89DDFF;">&gt;</span></span>
...
<span class="line"><span style="color:#89DDFF;">&lt;/</span><span style="color:#F07178;">my-btn</span><span style="color:#89DDFF;">&gt;</span></span>
<span class="line"></span>
<span class="line"></span></code></pre></div><h3 id="_5-8组件间通信与事件" tabindex="-1">5.8组件间通信与事件 <a class="header-anchor" href="#_5-8组件间通信与事件" aria-label="Permalink to &quot;5.8组件间通信与事件&quot;">​</a></h3><div class="language-js"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">(</span><span style="color:#F78C6C;">1</span><span style="color:#A6ACCD;">)父传子</span></span>
...
<span class="line"><span style="color:#A6ACCD;">wx.clearStorage()</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><div class="language-js"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#82AAFF;">set</span><span style="color:#A6ACCD;">()</span><span style="color:#89DDFF;">{</span></span>
...
<span class="line"><span style="color:#A6ACCD;">})</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><h4 id="_6-3-1get" tabindex="-1">6.3.1get <a class="header-anchor" href="#_6-3-1get" aria-label="Permalink to &quot;6.3.1get&quot;">​</a></h4><div class="language-js"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">  </span><span style="color:#82AAFF;">get</span><span style="color:#A6ACCD;">()</span><span style="color:#89DDFF;">{</span></span>
...
<span class="line"><span style="color:#F07178;">  </span><span style="color:#89DDFF;">},</span></span>
<span class="line"></span>
<span class="line"></span></code></pre></div><h4 id="_6-3-2post请求" tabindex="-1">6.3.2post请求 <a class="header-anchor" href="#_6-3-2post请求" aria-label="Permalink to &quot;6.3.2post请求&quot;">​</a></h4><div class="language-js"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">  </span><span style="color:#82AAFF;">post</span><span style="color:#A6ACCD;">()</span><span style="color:#89DDFF;">{</span></span>
<span class="line"><span style="color:#F07178;">    </span><span style="color:#A6ACCD;">wx</span><span style="color:#89DDFF;">.</span><span style="color:#82AAFF;">request</span><span style="color:#F07178;">(</span><span style="color:#89DDFF;">{</span></span>
...
<span class="line"><span style="color:#89DDFF;">}</span></span>
<span class="line"></span>
<span class="line"><span style="color:#89DDFF;font-style:italic;">export</span><span style="color:#A6ACCD;"> </span><span style="color:#89DDFF;font-style:italic;">default</span><span style="color:#A6ACCD;"> http</span></span>
<span class="line"></span>
<span class="line"></span></code></pre></div><div class="language-js"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">页面中调用：</span></span>
...
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><h3 id="_9-2基础库兼容" tabindex="-1">9.2基础库兼容 <a class="header-anchor" href="#_9-2基础库兼容" aria-label="Permalink to &quot;9.2基础库兼容&quot;">​</a></h3><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">暂无</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><h2 id="十、获取用户手机号" tabindex="-1">十、获取用户手机号 <a class="header-anchor" href="#十、获取用户手机号" aria-label="Permalink to &quot;十、获取用户手机号&quot;">​</a></h2><p>(1)获取微信用户绑定的手机号，需先调用wx.login接口; (2)需要用户主动触发才能发起获取手机号接口,该功能不由 API 来调用，需用 button 组件的点击来触发 (3)目前该接口针对非个人开发者，且完成了认证的小程序开放（不包含海外主体）</p><h3 id="_10-1微信登录" tabindex="-1">10.1微信登录 <a class="header-anchor" href="#_10-1微信登录" aria-label="Permalink to &quot;10.1微信登录&quot;">​</a></h3><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">暂无</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><h3 id="_10-2开放数据检验与解密" tabindex="-1">10.2开放数据检验与解密 <a class="header-anchor" href="#_10-2开放数据检验与解密" aria-label="Permalink to &quot;10.2开放数据检验与解密&quot;">​</a></h3><p>小程序可以通过各种前端接口获取微信提供的开放数据,但是开发者服务端获取这些开放数据时，需要对发放数据进行解密;</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;"></span></span>
...
<span class="line"><span style="color:#A6ACCD;">		云开发</span></span>
<span class="line"><span style="color:#A6ACCD;">		weui组件</span></span>
<span class="line"><span style="color:#A6ACCD;">		promise语法使用 promise.all  async  await语法糖</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div>`,97),e=[o];function t(c,r,D,y,F,i){return a(),n("div",null,e)}const u=s(p,[["render",t]]);export{A as __pageData,u as default};
