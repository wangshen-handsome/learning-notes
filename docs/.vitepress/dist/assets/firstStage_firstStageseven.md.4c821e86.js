...
<span class="line"><span style="color:#A6ACCD;">    - 代码演示</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><h6 id="textarea标签" tabindex="-1">textarea标签 <a class="header-anchor" href="#textarea标签" aria-label="Permalink to &quot;textarea标签&quot;">​</a></h6><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">- 作用：定义多行输入字段（文本域）</span></span>
...
<span class="line"><span style="color:#A6ACCD;">- 代码演示</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;">- 学员练习+讲师巡班：以上课堂代码</span></span>
...
<span class="line"><span style="color:#A6ACCD;">- 注意：form表单实现上述操作是最为常见方式之一，也可以使用其他方式，比如ajax等</span></span>
...
<span class="line"><span style="color:#A6ACCD;">- 效果描述：当用户选择该标签时，浏览器就会自动将焦点转到和标签相关的表单控件上</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><h3 id="表单区域" tabindex="-1">表单区域 <a class="header-anchor" href="#表单区域" aria-label="Permalink to &quot;表单区域&quot;">​</a></h3><h4 id="form标签-1" tabindex="-1">form标签 <a class="header-anchor" href="#form标签-1" aria-label="Permalink to &quot;form标签&quot;">​</a></h4><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">- 语法：&lt;form&gt;&lt;/form&gt;</span></span>
<span class="line"><span style="color:#A6ACCD;">- 作用：定义 HTML 表单域，是一个包含表单元素的区域。实现用户信息的收集和传递。举例说明：比如最为常见的交互操作，注册会员、跟帖留言或者文章发布等</span></span>
<span class="line"><span style="color:#A6ACCD;">- 注意：form表单实现上述操作是最为常见方式之一，也可以使用其他方式，比如ajax等</span></span>
...
<span class="line"><span style="color:#A6ACCD;">  - MDN: https://developer.mozilla.org/zh-CN/</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><h2 id="css-用户界面" tabindex="-1">CSS 用户界面 <a class="header-anchor" href="#css-用户界面" aria-label="Permalink to &quot;CSS 用户界面&quot;">​</a></h2><p>学习目标</p><ul><li>掌握如何清除表单输入框的轮廓线、禁止多行文本输入框重置大小</li><li>掌握如何定义鼠标样式</li></ul><h3 id="轮廓线" tabindex="-1">轮廓线 <a class="header-anchor" href="#轮廓线" aria-label="Permalink to &quot;轮廓线&quot;">​</a></h3><p>概述：轮廓（outline）是绘制于元素周围的一条线，位于边框边缘的外围，可起到突出元素的作用。 轮廓（outline）属性指定元素轮廓的样式、颜色和宽度。</p><p>outline简写</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">- 在一个声明中设置所有的轮廓属性。</span></span>
...
<span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;">如果不设置其中的某个值，也不会出问题，比如 outline:#ff0000 solid; 也是允许的。</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">- 代码演示：清除与设置 input的轮廓线</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><h3 id="重置元素大小" tabindex="-1">重置元素大小 <a class="header-anchor" href="#重置元素大小" aria-label="Permalink to &quot;重置元素大小&quot;">​</a></h3><p>默认：文本域中用户可以通过鼠标拖拽改变大小resize: none指定一个元素不允许用户调整大小</p><h3 id="css-鼠标样式" tabindex="-1">CSS 鼠标样式 <a class="header-anchor" href="#css-鼠标样式" aria-label="Permalink to &quot;CSS 鼠标样式&quot;">​</a></h3><p>通过在CSS中，cursor属性指定鼠标指针放在一个元素边界范围内时所用的光标形状</p><ul><li><p>常用值</p><ul><li>默认值： auto default 默认光标（通常是一个箭头） crosshair 光标呈现为十字线。 pointer 光标呈现为指示链接的指针（一只手） move 此光标指示某对象可被移动。</li><li>代码演示</li></ul></li><li><p>其他值</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">e-resize	此光标指示矩形框的边缘可被向右（东）移动。</span></span>
...
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">.wrap{</span></span>
...
<span class="line"><span style="color:#A6ACCD;">        } </span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><h4 id="实现步骤" tabindex="-1">实现步骤 <a class="header-anchor" href="#实现步骤" aria-label="Permalink to &quot;实现步骤&quot;">​</a></h4><ul><li>通过浮动创建一个正常的三列布局（不同列背景不同）</li><li>父容器清浮动</li><li>每一列固定padding-bottom，同时指定一个margin负值，抵销padding的占位</li><li>父容器overflow:hidden;</li></ul><h4 id="优缺点" tabindex="-1">优缺点 <a class="header-anchor" href="#优缺点" aria-label="Permalink to &quot;优缺点&quot;">​</a></h4><ul><li>合理的控制padding和margin值</li><li>可以实现任意列等高布局</li></ul><h3 id="方法二" tabindex="-1">方法二 <a class="header-anchor" href="#方法二" aria-label="Permalink to &quot;方法二&quot;">​</a></h3><p>原理：盒子层层嵌套，利用内层盒子高度变化，外层盒子的高度也会同步变化</p><p>（有几列就添加几层共同的父级，给父级设置不同的背景颜色，用left值将不同背景错开，用margin负值将子元素移动到不同背景颜色的父盒子上）</p><h4 id="实现步骤-1" tabindex="-1">实现步骤 <a class="header-anchor" href="#实现步骤-1" aria-label="Permalink to &quot;实现步骤&quot;">​</a></h4><ul><li>准备三个负责背景的盒子.bg1,.bg2,.bg3，HTML结构上层层嵌套</li><li>将.left,.center,.right盒子放入最内层的背景盒子.bg3里</li><li>最内层的盒子.bg3清浮动</li><li>将.bg2,.bg3相对于当前位置进行移动，形成三列背景效果</li><li>将.left,.center通过margin负值移动到对应的背景处即可</li></ul><div class="language-html"><button title="Copy Code" class="copy"></button><span class="lang">html</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;"> </span><span style="color:#89DDFF;">&lt;</span><span style="color:#F07178;">div</span><span style="color:#89DDFF;"> </span><span style="color:#C792EA;">class</span><span style="color:#89DDFF;">=</span><span style="color:#89DDFF;">&quot;</span><span style="color:#C3E88D;">wrap</span><span style="color:#89DDFF;">&quot;</span><span style="color:#89DDFF;">&gt;</span></span>
...
<span class="line"><span style="color:#A6ACCD;">  -webkit-box-orient 必须结合的属性 ，设置或检索伸缩盒对象的子元素的排列方式 。</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div>`,74),e=[o];function t(c,r,i,C,D,A){return a(),n("div",null,e)}const d=s(p,[["render",t]]);export{F as __pageData,d as default};
