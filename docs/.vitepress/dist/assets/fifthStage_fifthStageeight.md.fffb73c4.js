import{_ as s,o as a,c as n,N as l}from"./chunks/framework.e454f055.js";const F=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"fifthStage/fifthStageeight.md","lastUpdated":1684891561000}'),p={name:"fifthStage/fifthStageeight.md"},o=l(`<div class="language-js"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#676E95;font-style:italic;">/*</span></span>
...
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><h2 id="三、运行环境判断" tabindex="-1">三、运行环境判断 <a class="header-anchor" href="#三、运行环境判断" aria-label="Permalink to &quot;三、运行环境判断&quot;">​</a></h2><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">开发环境  开发过程中的环境   域名  http://localhost:3000</span></span>
...
<span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;">返回值：development（开发环境）   production （生产环境）</span></span>
...
<span class="line"></span></code></pre></div><h2 id="六、uview-组件库" tabindex="-1">六、uView 组件库 <a class="header-anchor" href="#六、uview-组件库" aria-label="Permalink to &quot;六、uView 组件库&quot;">​</a></h2><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">专门针对  uni-app框架设计的组件录</span></span>
...
<span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;">https://www.uviewui.com/</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><h3 id="_6-1安装" tabindex="-1">6.1安装 <a class="header-anchor" href="#_6-1安装" aria-label="Permalink to &quot;6.1安装&quot;">​</a></h3><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">通过下载方式安装：https://ext.dcloud.net.cn/plugin?id=6682</span></span>
<span class="line"><span style="color:#A6ACCD;">选择  下载插件 ZIP</span></span>
<span class="line"><span style="color:#A6ACCD;">下载完之后  把文件夹放到项目的根目录下，修改文件夹名字是 uview-ui</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><h3 id="_6-2配置" tabindex="-1">6.2配置 <a class="header-anchor" href="#_6-2配置" aria-label="Permalink to &quot;6.2配置&quot;">​</a></h3><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">配置地址：https://v1.uviewui.com/components/downloadSetting.html</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><h3 id="_6-3快速上手" tabindex="-1">6.3快速上手 <a class="header-anchor" href="#_6-3快速上手" aria-label="Permalink to &quot;6.3快速上手&quot;">​</a></h3><div class="language-html"><button title="Copy Code" class="copy"></button><span class="lang">html</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">	</span><span style="color:#89DDFF;">&lt;</span><span style="color:#F07178;">u-icon</span><span style="color:#89DDFF;"> </span><span style="color:#C792EA;">name</span><span style="color:#89DDFF;">=</span><span style="color:#89DDFF;">&quot;</span><span style="color:#C3E88D;">chat</span><span style="color:#89DDFF;">&quot;</span><span style="color:#89DDFF;">&gt;&lt;/</span><span style="color:#F07178;">u-icon</span><span style="color:#89DDFF;">&gt;</span></span>
<span class="line"><span style="color:#A6ACCD;">	</span><span style="color:#89DDFF;">&lt;</span><span style="color:#F07178;">u-count-down</span><span style="color:#89DDFF;"> </span><span style="color:#C792EA;">timestamp</span><span style="color:#89DDFF;">=</span><span style="color:#89DDFF;">&quot;</span><span style="color:#C3E88D;">3600</span><span style="color:#89DDFF;">&quot;</span><span style="color:#89DDFF;">&gt;&lt;/</span><span style="color:#F07178;">u-count-down</span><span style="color:#89DDFF;">&gt;</span></span>
<span class="line"></span>
<span class="line"></span></code></pre></div><h2 id="七、工程初始化" tabindex="-1">七、工程初始化 <a class="header-anchor" href="#七、工程初始化" aria-label="Permalink to &quot;七、工程初始化&quot;">​</a></h2><h3 id="_7-1项目介绍" tabindex="-1">7.1项目介绍 <a class="header-anchor" href="#_7-1项目介绍" aria-label="Permalink to &quot;7.1项目介绍&quot;">​</a></h3><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">前端：uni-app框架和 uviewui框架 写的  多端商城项目</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;">后端：express框架+mysql+node        后端接口</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><h3 id="_7-2服务端初始化" tabindex="-1">7.2服务端初始化 <a class="header-anchor" href="#_7-2服务端初始化" aria-label="Permalink to &quot;7.2服务端初始化&quot;">​</a></h3><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">1、运行管理后台 （vue项目 + elementui）</span></span>
...
<span class="line"><span style="color:#A6ACCD;">   npm i</span></span>
<span class="line"><span style="color:#A6ACCD;">   npm start</span></span>
<span class="line"><span style="color:#A6ACCD;">	连接数据库（注意数据库的连接参数）</span></span>
<span class="line"><span style="color:#A6ACCD;">	</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><h3 id="_7-3导入工程模板" tabindex="-1">7.3导入工程模板 <a class="header-anchor" href="#_7-3导入工程模板" aria-label="Permalink to &quot;7.3导入工程模板&quot;">​</a></h3><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">复制静态文件   新建一个u-shop  项目的目录</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><h3 id="_7-4工程运行" tabindex="-1">7.4工程运行 <a class="header-anchor" href="#_7-4工程运行" aria-label="Permalink to &quot;7.4工程运行&quot;">​</a></h3><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">运行到h5</span></span>
<span class="line"><span style="color:#A6ACCD;">运行到微信</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><h2 id="八、首页数据" tabindex="-1">八、首页数据 <a class="header-anchor" href="#八、首页数据" aria-label="Permalink to &quot;八、首页数据&quot;">​</a></h2><h3 id="_8-1骨架屏" tabindex="-1">8.1骨架屏 <a class="header-anchor" href="#_8-1骨架屏" aria-label="Permalink to &quot;8.1骨架屏&quot;">​</a></h3><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">暂无</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><h3 id="_8-2商品分类快速导航" tabindex="-1">8.2商品分类快速导航 <a class="header-anchor" href="#_8-2商品分类快速导航" aria-label="Permalink to &quot;8.2商品分类快速导航&quot;">​</a></h3><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">暂无</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><h3 id="_8-3商品活动banner" tabindex="-1">8.3商品活动banner <a class="header-anchor" href="#_8-3商品活动banner" aria-label="Permalink to &quot;8.3商品活动banner&quot;">​</a></h3><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">暂无</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><h3 id="_8-4商品秒杀活动" tabindex="-1">8.4商品秒杀活动 <a class="header-anchor" href="#_8-4商品秒杀活动" aria-label="Permalink to &quot;8.4商品秒杀活动&quot;">​</a></h3><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">暂无</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><h3 id="_8-5热门推荐商品" tabindex="-1">8.5热门推荐商品 <a class="header-anchor" href="#_8-5热门推荐商品" aria-label="Permalink to &quot;8.5热门推荐商品&quot;">​</a></h3><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">暂无</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><h2 id="九、商品分类列表" tabindex="-1">九、商品分类列表 <a class="header-anchor" href="#九、商品分类列表" aria-label="Permalink to &quot;九、商品分类列表&quot;">​</a></h2><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">暂无</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><h2 id="十、课后作业" tabindex="-1">十、课后作业 <a class="header-anchor" href="#十、课后作业" aria-label="Permalink to &quot;十、课后作业&quot;">​</a></h2><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">完成当天项目内容</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div>`,47),e=[o];function t(c,r,i,y,D,C){return a(),n("div",null,e)}const d=s(p,[["render",t]]);export{F as __pageData,d as default};
