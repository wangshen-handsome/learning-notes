...
<span class="line"><span style="color:#A6ACCD;">    </span></span>
<span class="line"><span style="color:#A6ACCD;">&lt;/script&gt;</span></span>
<span class="line"><span style="color:#A6ACCD;">320px 1rem=20px   640px 40px     20px/320px=当前屏幕字体基准值/640px</span></span>
...
<span class="line"><span style="color:#A6ACCD;">vmin相对于视口的宽度或高度中较小的那个The 。其中最小的那个被均分为100单位的vmin。</span></span>
...
<span class="line"><span style="color:#A6ACCD;">100px就是13.333333vw了</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><p>然后我们就可以在布局写rem单位了, 由于倍率是100,除以100,直接小数点向左移动2位,1rem是100px,那么10px就是0.1rem，不需要借助插件转换计算也可以直观的进行布局了。</p><h5 id="rem-vw" tabindex="-1">rem+vw; <a class="header-anchor" href="#rem-vw" aria-label="Permalink to &quot;rem+vw;&quot;">​</a></h5><p>vw是相对于视口宽度的单位，当视口宽度发生变化，则元素大小随即发生变化。</p><p>vh是相对于视口高度的单位</p><p>此处注意：rem+vw布局不需要设置媒体查询和js代码，就可以进行一个自适应</p><p>将视口分为100份。一份相当于1vw。</p><p>以750px 的设计稿为例 视口平分100份</p><p>750px=100vw ==》 1px=0.13333333vw ==》 100px=13.33333vw 100px = 1rem</p><p>px-》vw-&gt;rem的转换</p><p>注意字体基准值的设置：</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">       html{</span></span>
