...
<span class="line"><span style="color:#A6ACCD;">}</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><ul><li>线上图片直接使用</li><li>线上图片放在data数据中使用</li><li>直接引入本地文件夹中的图片</li><li>node导入图片到data中</li><li>es6导入图片到data中</li></ul>`,102),D=[r];function y(i,C,F,A,d,h){return n(),a("div",null,D)}const m=s(c,[["render",y]]);export{g as __pageData,m as default};
