...
const __pageData = JSON.parse('{"title":"一阶段 | 第八天","description":"","frontmatter":{"layout":"firstStageeight","title":"一阶段 | 第八天"},"headers":[],"relativePath":"firstStage/firstStageeight.md","filePath":"firstStage/firstStageeight.md"}');
const _sfc_main = { name: "firstStage/firstStageeight.md" };
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<div${ssrRenderAttrs(_attrs)}><ul><li>能够说出圣杯布局、双飞翼布局解决的是什么问题？</li><li>认识常见的CSS Hack</li><li>掌握PS的基础应用</li><li>熟练使用cutterman切图</li><li>掌握CSS项目规范</li></ul><h1 id="圣杯布局-双飞翼" tabindex="-1">圣杯布局&amp;双飞翼 <a class="header-anchor" href="#圣杯布局-双飞翼" aria-label="Permalink to &quot;圣杯布局&amp;双飞翼&quot;">​</a></h1><h2 id="分析实现要点" tabindex="-1">分析实现要点 <a class="header-anchor" href="#分析实现要点" aria-label="Permalink to &quot;分析实现要点&quot;">​</a></h2><ul><li>三列（不一定等高）</li><li>改变加载顺序，优先加载中间列—（结构上:中左右，显示效果上：左中右）</li><li>中间列自适应，两侧列固定</li></ul><h2 id="圣杯" tabindex="-1">圣杯 <a class="header-anchor" href="#圣杯" aria-label="Permalink to &quot;圣杯&quot;">​</a></h2><h4 id="html" tabindex="-1">HTML <a class="header-anchor" href="#html" aria-label="Permalink to &quot;HTML&quot;">​</a></h4><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="${ssrRenderStyle({ "color": "#A6ACCD" })}">&lt;div class=&quot;wrap&quot;&gt;</span></span>
<span class="line"><span style="${ssrRenderStyle({ "color": "#A6ACCD" })}">        &lt;div class=&quot;center&quot;&gt;中间&lt;/div&gt;</span></span>
<span class="line"><span style="${ssrRenderStyle({ "color": "#A6ACCD" })}">        &lt;div class=&quot;left&quot;&gt;左侧&lt;/div&gt;</span></span>
<span class="line"><span style="${ssrRenderStyle({ "color": "#A6ACCD" })}">        &lt;div class=&quot;right&quot;&gt;右侧&lt;/div&gt;</span></span>
<span class="line"><span style="${ssrRenderStyle({ "color": "#A6ACCD" })}">    &lt;/div&gt;</span></span></code></pre></div><h4 id="css" tabindex="-1">CSS <a class="header-anchor" href="#css" aria-label="Permalink to &quot;CSS&quot;">​</a></h4><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="${ssrRenderStyle({ "color": "#A6ACCD" })}">.wrap:after{</span></span>
<span class="line"><span style="${ssrRenderStyle({ "color": "#A6ACCD" })}">content:&quot;&quot;;</span></span>
<span class="line"><span style="${ssrRenderStyle({ "color": "#A6ACCD" })}">display: block;</span></span>
<span class="line"><span style="${ssrRenderStyle({ "color": "#A6ACCD" })}">clear: both;</span></span>
<span class="line"><span style="${ssrRenderStyle({ "color": "#A6ACCD" })}">}</span></span>
<span class="line"><span style="${ssrRenderStyle({ "color": "#A6ACCD" })}">.wrap{</span></span>
<span class="line"><span style="${ssrRenderStyle({ "color": "#A6ACCD" })}">border:1px solid #000;</span></span>
<span class="line"><span style="${ssrRenderStyle({ "color": "#A6ACCD" })}">padding:0 200px;</span></span>
<span class="line"><span style="${ssrRenderStyle({ "color": "#A6ACCD" })}">min-width:200px;</span></span>
<span class="line"><span style="${ssrRenderStyle({ "color": "#A6ACCD" })}">}</span></span>
<span class="line"><span style="${ssrRenderStyle({ "color": "#A6ACCD" })}">.left,.center,.right{</span></span>
<span class="line"><span style="${ssrRenderStyle({ "color": "#A6ACCD" })}">float:left;</span></span>
<span class="line"><span style="${ssrRenderStyle({ "color": "#A6ACCD" })}">}</span></span>
<span class="line"><span style="${ssrRenderStyle({ "color": "#A6ACCD" })}"></span></span>
<span class="line"><span style="${ssrRenderStyle({ "color": "#A6ACCD" })}">.left{</span></span>
<span class="line"><span style="${ssrRenderStyle({ "color": "#A6ACCD" })}">width:200px;</span></span>
<span class="line"><span style="${ssrRenderStyle({ "color": "#A6ACCD" })}">min-height:200px;</span></span>
<span class="line"><span style="${ssrRenderStyle({ "color": "#A6ACCD" })}">background-color: pink;</span></span>
<span class="line"><span style="${ssrRenderStyle({ "color": "#A6ACCD" })}">margin-left:-100%;</span></span>
<span class="line"><span style="${ssrRenderStyle({ "color": "#A6ACCD" })}">position: relative;</span></span>
<span class="line"><span style="${ssrRenderStyle({ "color": "#A6ACCD" })}">left:-200px;</span></span>
<span class="line"><span style="${ssrRenderStyle({ "color": "#A6ACCD" })}">}</span></span>
<span class="line"><span style="${ssrRenderStyle({ "color": "#A6ACCD" })}">.right{</span></span>
<span class="line"><span style="${ssrRenderStyle({ "color": "#A6ACCD" })}">width:200px;</span></span>
<span class="line"><span style="${ssrRenderStyle({ "color": "#A6ACCD" })}">min-height:200px;</span></span>
<span class="line"><span style="${ssrRenderStyle({ "color": "#A6ACCD" })}">background-color: skyblue;</span></span>
<span class="line"><span style="${ssrRenderStyle({ "color": "#A6ACCD" })}">margin-left:-200px;</span></span>
<span class="line"><span style="${ssrRenderStyle({ "color": "#A6ACCD" })}">position:relative;</span></span>
<span class="line"><span style="${ssrRenderStyle({ "color": "#A6ACCD" })}">left:200px;</span></span>
<span class="line"><span style="${ssrRenderStyle({ "color": "#A6ACCD" })}">}</span></span>
<span class="line"><span style="${ssrRenderStyle({ "color": "#A6ACCD" })}"></span></span>
<span class="line"><span style="${ssrRenderStyle({ "color": "#A6ACCD" })}">.center{</span></span>
<span class="line"><span style="${ssrRenderStyle({ "color": "#A6ACCD" })}">width:100%;</span></span>
<span class="line"><span style="${ssrRenderStyle({ "color": "#A6ACCD" })}">min-height:200px;</span></span>
<span class="line"><span style="${ssrRenderStyle({ "color": "#A6ACCD" })}">background-color: yellowgreen;</span></span>
<span class="line"><span style="${ssrRenderStyle({ "color": "#A6ACCD" })}"></span></span>
<span class="line"><span style="${ssrRenderStyle({ "color": "#A6ACCD" })}">}</span></span></code></pre></div><h4 id="圣杯实现步骤" tabindex="-1">圣杯实现步骤 <a class="header-anchor" href="#圣杯实现步骤" aria-label="Permalink to &quot;圣杯实现步骤&quot;">​</a></h4><ul><li>外框左右固定padding值，预留左侧列和右侧列的列宽</li><li>.center宽度100%，.left,.right固定宽度</li><li>结构上.center,.left,.right依次浮动在一行排列</li><li>移动.left通过margin-left:-100%配合相对定位position:relative,left:-200px;移动至左侧列位置</li><li>移动.right通过margin-left:-200px;配合相对定位position:relative;left:200px移动至右侧列位置</li></ul><h2 id="双飞翼" tabindex="-1">双飞翼 <a class="header-anchor" href="#双飞翼" aria-label="Permalink to &quot;双飞翼&quot;">​</a></h2><h4 id="html-1" tabindex="-1">HTML <a class="header-anchor" href="#html-1" aria-label="Permalink to &quot;HTML&quot;">​</a></h4><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="${ssrRenderStyle({ "color": "#A6ACCD" })}">&lt;div class=&quot;wrap&quot;&gt;</span></span>
<span class="line"><span style="${ssrRenderStyle({ "color": "#A6ACCD" })}">    &lt;div class=&quot;centerbox&quot;&gt;</span></span>
<span class="line"><span style="${ssrRenderStyle({ "color": "#A6ACCD" })}">       &lt;div class=&quot;center&quot;&gt;中间&lt;/div&gt;</span></span>
<span class="line"><span style="${ssrRenderStyle({ "color": "#A6ACCD" })}">    &lt;/div&gt;</span></span>
<span class="line"><span style="${ssrRenderStyle({ "color": "#A6ACCD" })}">    &lt;div class=&quot;left&quot;&gt;左侧&lt;/div&gt;</span></span>
<span class="line"><span style="${ssrRenderStyle({ "color": "#A6ACCD" })}">    &lt;div class=&quot;right&quot;&gt;右侧&lt;/div&gt;</span></span>
<span class="line"><span style="${ssrRenderStyle({ "color": "#A6ACCD" })}">&lt;/div&gt;</span></span></code></pre></div><h4 id="css-1" tabindex="-1">CSS <a class="header-anchor" href="#css-1" aria-label="Permalink to &quot;CSS&quot;">​</a></h4><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="${ssrRenderStyle({ "color": "#A6ACCD" })}">.wrap:after {</span></span>
<span class="line"><span style="${ssrRenderStyle({ "color": "#A6ACCD" })}">            content: &quot;&quot;;</span></span>
<span class="line"><span style="${ssrRenderStyle({ "color": "#A6ACCD" })}">            display: block;</span></span>
<span class="line"><span style="${ssrRenderStyle({ "color": "#A6ACCD" })}">            clear: both;</span></span>
<span class="line"><span style="${ssrRenderStyle({ "color": "#A6ACCD" })}">        }</span></span>
...
<span class="line"><span style="${ssrRenderStyle({ "color": "#A6ACCD" })}">        .wrap {</span></span>
<span class="line"><span style="${ssrRenderStyle({ "color": "#A6ACCD" })}">            border: 1px solid #000;</span></span>
<span class="line"><span style="${ssrRenderStyle({ "color": "#A6ACCD" })}">            min-width:600px;</span></span>
<span class="line"><span style="${ssrRenderStyle({ "color": "#A6ACCD" })}">           </span></span>
<span class="line"><span style="${ssrRenderStyle({ "color": "#A6ACCD" })}">        }</span></span>
<span class="line"><span style="${ssrRenderStyle({ "color": "#A6ACCD" })}"></span></span>
<span class="line"><span style="${ssrRenderStyle({ "color": "#A6ACCD" })}">        .left,</span></span>
<span class="line"><span style="${ssrRenderStyle({ "color": "#A6ACCD" })}">        .centerbox,</span></span>
<span class="line"><span style="${ssrRenderStyle({ "color": "#A6ACCD" })}">        .right {</span></span>
<span class="line"><span style="${ssrRenderStyle({ "color": "#A6ACCD" })}">            float: left;</span></span>
<span class="line"><span style="${ssrRenderStyle({ "color": "#A6ACCD" })}">        }</span></span>
<span class="line"><span style="${ssrRenderStyle({ "color": "#A6ACCD" })}">        .centerbox{</span></span>
...
<span class="line"><span style="${ssrRenderStyle({ "color": "#A6ACCD" })}">        } </span></span>
<span class="line"><span style="${ssrRenderStyle({ "color": "#A6ACCD" })}">        .center {</span></span>
<span class="line"><span style="${ssrRenderStyle({ "color": "#A6ACCD" })}">            margin:0 200px;</span></span>
<span class="line"><span style="${ssrRenderStyle({ "color": "#A6ACCD" })}">            min-height: 200px;</span></span>
<span class="line"><span style="${ssrRenderStyle({ "color": "#A6ACCD" })}">            background-color: yellowgreen; </span></span>
<span class="line"><span style="${ssrRenderStyle({ "color": "#A6ACCD" })}">        }</span></span></code></pre></div><h4 id="双飞翼实现步骤" tabindex="-1">双飞翼实现步骤 <a class="header-anchor" href="#双飞翼实现步骤" aria-label="Permalink to &quot;双飞翼实现步骤&quot;">​</a></h4><ul><li>.centerbox与.left,.right浮动在一行排列</li><li>.centerbox固定宽度100%，left,.right固定宽度</li><li>.centerbox内部嵌套.center,不定宽度，通过定义左右margin留出左侧列的宽和右侧列宽</li><li>移动.left通过margin-left:-100%实现</li><li>移动.right通过margin-left:-200px;实现</li></ul><h1 id="css-hack" tabindex="-1">CSS Hack <a class="header-anchor" href="#css-hack" aria-label="Permalink to &quot;CSS Hack&quot;">​</a></h1><p>使用 CSS Hack 【可以控制不同浏览器及版本之间的显示差异】，</p><p>某些情况下处理兼容问题可以事半功倍，但【滥用会影响页面性能】，也会导致后期维护困难，因此尽可能减少对CSS Hack 的使用。</p><h3 id="属性级hack" tabindex="-1">属性级hack <a class="header-anchor" href="#属性级hack" aria-label="Permalink to &quot;属性级hack&quot;">​</a></h3><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="${ssrRenderStyle({ "color": "#A6ACCD" })}">*星号   针对ie6、7</span></span>
<span class="line"><span style="${ssrRenderStyle({ "color": "#A6ACCD" })}">.box{ *display:inline }</span></span>
<span class="line"><span style="${ssrRenderStyle({ "color": "#A6ACCD" })}"></span></span>
<span class="line"><span style="${ssrRenderStyle({ "color": "#A6ACCD" })}">_下划线  针对ie6  </span></span>
<span class="line"><span style="${ssrRenderStyle({ "color": "#A6ACCD" })}"></span></span>
<span class="line"><span style="${ssrRenderStyle({ "color": "#A6ACCD" })}">.box{ _display:inline; }</span></span>
<span class="line"><span style="${ssrRenderStyle({ "color": "#A6ACCD" })}"></span></span>
<span class="line"><span style="${ssrRenderStyle({ "color": "#A6ACCD" })}">\\0    针对ie8+</span></span>
<span class="line"><span style="${ssrRenderStyle({ "color": "#A6ACCD" })}">.box{ background:blue\\0; }</span></span></code></pre></div><h3 id="选择符级hack" tabindex="-1">选择符级hack <a class="header-anchor" href="#选择符级hack" aria-label="Permalink to &quot;选择符级hack&quot;">​</a></h3><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="${ssrRenderStyle({ "color": "#A6ACCD" })}">*html .box{</span></span>
<span class="line"><span style="${ssrRenderStyle({ "color": "#A6ACCD" })}"> width:200px;</span></span>
<span class="line"><span style="${ssrRenderStyle({ "color": "#A6ACCD" })}"> height:200px;</span></span>
<span class="line"><span style="${ssrRenderStyle({ "color": "#A6ACCD" })}"> background:black;</span></span>
<span class="line"><span style="${ssrRenderStyle({ "color": "#A6ACCD" })}">} </span></span>
